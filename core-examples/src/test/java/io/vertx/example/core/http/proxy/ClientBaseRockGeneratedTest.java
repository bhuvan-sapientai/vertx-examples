...
class ClientBaseRockGeneratedTest {
    ...
    //BaseRock generated method id: ${startWhenILessThan10}, hash: EA7167EEA23494BF382AACD98543B08C
    @Test()
    void startWhenILessThan10() throws Exception {
         ...
         */
         //Arrange Statement(s)
        doReturn(clientMock).when(vertxMock).createHttpClient();
        ...
        assertAll("result", () -> {
            ...
            verify(vertxMock).createHttpClient();
